            ...
            <div class="container-fluid">
				...
				<%  if((String)session.getAttribute("success") != null){
					...
					if(success.equals("success")){%>
								<div class="alert alert-success" role="alert">New employee has been added.</div>
					<%}
					if(success.equals("successDelete")){%>
								<div class="alert alert-success" role="alert">Employee has been deleted.</div>
                                  ...
                                  <tr>
									 ...
									 <td>
										<form action="viewEmployee.jsp" method="post">
											...
											<h5 style="color:blue"><button id="editButton" name="likes" type="submit" style="" class="pull-right">View</button></h5>
										</form>		
									</td>
                                  </tr>
<%
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabel">Adding a new Employee</h4>
							</div>
							<div class="modal-body">
								<!-- The form is placed inside the body of modal -->
								<form id="updateInformation" method="post" class="form-horizontal" action="addEmployee.jsp">
									
									<div class="form-group">
									<label class="col-sm-3 control-label"></label>
										<div class="col-sm-5">
												<input type="hidden" name="redirected" value="employee"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-5">
											<input id="disabledInput" type="text" class="form-control" name="SSN" value="">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-5">
											<input id="disabledInput" type="text" class="form-control" name="startDate" value="">
										</div>
									</div>
