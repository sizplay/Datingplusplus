...
<html lang="en">
    ...
    <body background="./images/background.jpg">
        ...
        <div class="col-md-9">
            <%
                ...
                if (rs1 != null && rs1.next()) {
                    ...
                    String strQuery = "SELECT P.ProfileID FROM Profile P WHERE P.OwnerSSN = '"+SSN+"'";
        ...
        <div class="container"> 
            ...
            <!-- /.row --> 
            <form action="ChoiceOfprofileID.jsp" method="post">
                <!-- LikeModal -->
                <div class="modal fade" id="ChoiceProfileID" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <select class="required form-control" id="ChoiceProfileID1" name="ChoiceProfileID1">
