...
<%
    ...
    if ((firstName != null) && (lastName != null)) {
        if (firstName.trim().equals("") || lastName.trim().equals("")) {
            ...
            String insertAcct = "INSERT INTO Account"
                    + " (SSN, CardNumber, AcctNum, AcctCreation)"
                    + " VALUES(?,?,?,?)";
            stm = conn.prepareStatement(insertAcct);
            stm.setString(1, SSN);
            stm.setString(2, cardNum);
            stm.setString(3, acctNum);
            stm.setTimestamp(4, timestamp);
            stm.executeUpdate();
