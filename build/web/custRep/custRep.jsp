        ...
        <div class="container"> 
            ...
            <div class="row"> 
                ...
                <div class="col-md-3">
                    ...
                    <div class="list-group"> <a href="profile.jsp" style="text-align:center" class="list-group-item">Add information for a customer</a> 
                        <a href="account.jsp" style="text-align:center" class="list-group-item">Edit information for a customer</a>
                        <a href="likes.jsp" style="text-align:center" class="list-group-item">Delete customer information</a> 
                        <a href="likes.jsp" style="text-align:center" class="list-group-item">Produce customer mailing lists</a>
                        <a href="likes.jsp" style="text-align:center" class="list-group-item">Produce a list of profiles as date suggestions</a>
                        <a href="likes.jsp" style="text-align:center" class="list-group-item">Record a date</a>
                    </div>
                </div>
                <!-- Content Column --> 
                <!-- PROFILE -->
