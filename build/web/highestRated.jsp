    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<p>This is a list of customers based on their ratings.</p>
...
<%
				...
				try{
					...
					String strQuery = "SELECT FirstName, LastName, User.SSN, Rating, PPP, DateOfLastAct FROM User JOIN Person ON User.SSN = Person.SSN ORDER BY User.Rating DESC";
