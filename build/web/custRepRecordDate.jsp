    ...
    <body background="./images/background.jpg">
        ...
        <div class="col-md-9">
            <%
                ...
                String queryDateTable = "SELECT * FROM Date WHERE BookingFee = '0'";
                PreparedStatement stm = conn.prepareStatement(queryDateTable);
                ResultSet rs2 = stm.executeQuery();
                while (rs2.next()) {
                    result = rs2.getString("Profile1") + " and " + rs2.getString("Profile2");
                    profile1.add(result);
                }
                //}
        ...
        <div class="container"> 
            ...
            <div class="row"> 
                ...
                <!-- Content Column --> 
                <!-- PROFILE -->
                <form action="custRepInsertDateIntoDB.jsp" method="post">
                    <div class="container">
                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <table class="table table-user-information">
                                                    <tbody>
                                                    <h3>Please validate the dates between the following profiles:</h3>
                                                    <select class="required form-control" id="profileID" name="profileID">
                                                        <option selected="selected" value="-1"></option>
                                                        <%
                                                            Iterator i = profile1.iterator();
                                                            while (i.hasNext()) {%>
